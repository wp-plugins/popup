...
function PPOPOUPUP_admin_options() 
{
	...
	echo '<p>Random message	:	<input  style="width: 350px;" type="text" value="';
	echo $PPOPOUPUP_RANDOM . '" name="PPOPOUPUP_RANDOM" id="PPOPOUPUP_RANDOM" /> (YES/NO) </p>';
	
	echo '<p>Popup IMG1 txt	: <input  style="width: 500px;" type="text" value="';
	echo $PPOPOUPUP_IMG1 . '" name="PPOPOUPUP_IMG1" id="PPOPOUPUP_IMG1" /> (IMG1)</p>';
	echo '<p>Popup IMG1 url 	: <input  style="width: 500px;" type="text" value="';
	echo $PPOPOUPUP_URL1 . '" name="PPOPOUPUP_URL1" id="PPOPOUPUP_URL1" /> </p>';
	
	echo '<p>Popup IMG2 txt : <input  style="width: 500px;" type="text" value="';
	echo $PPOPOUPUP_IMG2 . '" name="PPOPOUPUP_IMG2" id="PPOPOUPUP_IMG2" /> (IMG2)</p>';
	echo '<p>Popup IMG2 url : <input  style="width: 500px;" type="text" value="';
	echo $PPOPOUPUP_URL2 . '" name="PPOPOUPUP_URL2" id="PPOPOUPUP_URL2" /> </p>';
	
	echo '<p>Popup IMG3 txt : <input  style="width: 500px;" type="text" value="';
	echo $PPOPOUPUP_IMG3 . '" name="PPOPOUPUP_IMG3" id="PPOPOUPUP_IMG3" /> (IMG3)</p>';
	echo '<p>Popup IMG3 url : <input  style="width: 500px;" type="text" value="';
	echo $PPOPOUPUP_URL3 . '" name="PPOPOUPUP_URL3" id="PPOPOUPUP_URL3" /> </p>';
	
	echo '<p>Popup IMG4 txt : <input  style="width: 500px;" type="text" value="';
	echo $PPOPOUPUP_IMG4 . '" name="PPOPOUPUP_IMG4" id="PPOPOUPUP_IMG4" /> (IMG4)</p>';
	echo '<p>Popup IMG4 url : <input  style="width: 500px;" type="text" value="';
	echo $PPOPOUPUP_URL4 . '" name="PPOPOUPUP_URL4" id="PPOPOUPUP_URL4" /> </p>';
	
	echo '<p>Popup IMG5 txt : <input  style="width: 500px;" type="text" value="';
	echo $PPOPOUPUP_IMG5 . '" name="PPOPOUPUP_IMG5" id="PPOPOUPUP_IMG5" /> (IMG5)</p>';
	echo '<p>Popup IMG5 url : <input  style="width: 500px;" type="text" value="';
	echo $PPOPOUPUP_URL5 . '" name="PPOPOUPUP_URL5" id="PPOPOUPUP_URL5" /> </p>';
	
	echo '<p>Popup IMG6 txt : <input  style="width: 500px;" type="text" value="';
	echo $PPOPOUPUP_IMG6 . '" name="PPOPOUPUP_IMG6" id="PPOPOUPUP_IMG6" /> (IMG6)</p>';
	echo '<p>Popup IMG6 url : <input  style="width: 500px;" type="text" value="';
  ...
  <a target="_blank" href='http://www.gopiplus.com/work/2011/01/14/wordpress-popup/'>Click here</a> To download my other plugins, support.<br>
